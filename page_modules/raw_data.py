...
def render(vacuum_df, personnel_df):
    """Render raw data page with site column prominence"""
    ...
    if vacuum_df.empty:
        ...
        with col2:
            num_rows = st.number_input("Rows to show", min_value=10, max_value=1000, value=100, step=10)
    ...
    if personnel_df.empty:
        ...
        # Show data
        st.dataframe(display_df.head(num_rows_personnel), use_container_width=True, height=400)
    ...
    with st.expander("💡 Using Raw Data"):
        ...
        **Multi-Site Features:**
        ...
        - **Site Column**: Now prominently displayed at the front
        ...
        **Improving Site Classification:**
        
        If you see many UNK entries in personnel data:
        1. Look at example Job descriptions in the UNK section
        2. Update Job entries to include "NY" or "VT"
        3. Use format like: "Tapping - VT Woods" or "Maintenance - NY Mainline 3"
        4. After updates, click "Refresh Data" to reload
        ...
        **Troubleshooting:**
        ...
        - **Missing Site column**: Data may be from before multi-site update
        - **All sites showing as UNK**: Check Job column format
        - **Unexpected site assignments**: Review Job descriptions
        - **Site mismatch**: Verify sheet URLs are correct in configuration
        """)
